...
export const MenuItem = ({ label, Icon, Button, onClick }: MenuItemProps) => {
    ...
    return (
        ...
        className='flex items-center -my-1 ml-7 border-l-3 border-b-3 border-b-transparent 
...
export const UserMenuItem = ({ label, Icon, onClick }: MenuItemProps) => {
