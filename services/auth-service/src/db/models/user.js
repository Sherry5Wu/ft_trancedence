...
export default (sequelize) => { // export a default function, not the User model itself
  const User = sequelize.define('User', {
    ...
    passwordHash: {
      type: DataTypes.STRING(60), // bcrypt--> always 60 characters
      allowNull: true,
    },
    pinCodeHash: {
      type: DataTypes.STRING(60), // bcrypt--> always 60 characters
    ...
    googleId: {
      type: DataTypes.STRING(40), // usually around 21-30 chars
      unique: true,
    },
    twoFASecret: {
    ...
    backupCodes: {
      type: DataTypes.JSON,
      comment: 'Useful for recovery if the user loses access to their authenticator app (stores an array of codes)',
    },
    is2FAEnabled: {
