...
#AUTH_FILES = services/auth-service/Dockerfile services/auth-service/src/app.js services/auth-service/package.json
BACKEND_FILES = $(DOCKER_COMPOSE_FILE) $(TOURNAMENT_FILES) $(USER_FILES) $(GATEWAY_FILES) #$(AUTH_FILES) $(ENV_FILE)
